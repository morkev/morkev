```python
       ...
       `:.+-          -+.:`               ——————
     -` .s-            -s. `-             Uptime: "20 years, 11 months, 23 days"
   `.-/+:/-            -/:+/-.`           OS: "Linux, macOS & Windows"
       .s1/`          `/9o.               College: "Salt Lake Community College"
 -`   `-/s/-:.      .:-/s/-`   `-         Transfer: "University of Utah"
`-/+--8o+-/+o+--::--+o+/-+o4--+/-`        Languages.RL: "English & Spanish"
` .+:+s+:-:ommy+::+ymmo:-:+s+:+. `        Languages.CS(x): "Java, C++, Python, SQL/MySQL, JavaScript, C"
.:/+..  `..`:///--///:`..` `..+/:.        Languages.CS(y): "R, PHP, HTML, CSS, Processing, TeX, Assembly"
